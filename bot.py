...
# Config
class Config:
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7753787415:AAFX02qLbMxkLKGX0KwhQ4N7jx_d3QK4dvw")
    APP_ID = int(os.environ.get("APP_ID", 37465864))
    API_HASH = os.environ.get("API_HASH", "ede72ad9dcc688e9d98ed0a95dd49879")
    AUTH_USERS = {int(x) for x in os.environ.get("AUTH_USERS", "6750330391").split(",")}
